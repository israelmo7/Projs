...
| File | Description |
|------|-------------|
| `1.png` | Soundboard trigger image #1 |
| `2.png` | Soundboard trigger image #2 |
| `3.png` | Soundboard trigger image #3 |
| `4.png` | Soundboard trigger image #4 |
| `5.png` | Soundboard trigger image #5 |
| `6.png` | Soundboard trigger image #6 |
| `7.png` | Soundboard trigger image #7 |
